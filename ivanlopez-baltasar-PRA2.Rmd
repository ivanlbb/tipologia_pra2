...
Tampoco obtenemos unas correlaciones altas por lo que consideramos que un modelo de regresión lineal no va a ser de utilidad para predecir la calidad de los vinos.
...
Vemos que el resultado es excelente, el modelo nos clasifica los vinos con una precisión del 99.65% con un índice **kappa=0.99**   que nos indica que nuestra clasificación es un 99% mejor que una clasificación aleatoria.  

Probamos el modelo con la muestra de prueba
...
Vemos que ha clasificado bien un 98.9% de la muestra.
...
cat("Error en la estimación del atributo calidad: ", errorCART)
